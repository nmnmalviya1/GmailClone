import createmail from './icons/create_32dp.png'
...
<div class="left-sidebar-compose">
  <button class="sidebar-btn-compose">
    <img src={createmail} alt="Compose a new email" class="sidebar-btn-compose-icon" />
    <span class="sidebar-btn-compose-title">Compose xyz</span>
  </button>
</div>
