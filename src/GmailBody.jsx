...
import check_box_outline_blank_black_24dp from "./icons/check_box_outline_blank_black_24dp.svg"
import arrow_drop_down_black_24dp from "./icons/arrow_drop_down_black_24dp.svg"
import PromiseExample from "./PromiseExample";
import refresh_black_24dp from "./icons/refresh_black_24dp.svg"
import more_vert_black_20dp from "./icons/more_vert_black_20dp.png"
import chevron_left_black_24dp from "./icons/chevron_left_black_24dp.svg"
import chevron_right_black_24dp from "./icons/chevron_right_black_24dp.svg"
import keyboard_black_24dp from "./icons/keyboard_black_24dp.svg"
        ...
        <div class="inbox-menu-group">
          ...
          <div class="inbox-btn-group" >
            <button class="btn-alt">
              <img src={check_box_outline_blank_black_24dp} alt="Select" class="btn-icon-sm btn-icon-alt btn-icon-hover" />
            </button>

            <button class="btn-sm btn-alt">
              <img src={arrow_drop_down_black_24dp} alt="Select" class="btn-icon-sm btn-icon-alt btn-icon-hover" />
            </button>
          </div>

          <button class="btn">
            <img src={refresh_black_24dp} alt="Refresh" class="btn-icon btn-icon-sm btn-icon-alt btn-icon-hover" />
          </button>

          <button class="btn">
            <img src={more_vert_black_20dp}alt="More" class="btn-icon btn-icon-sm btn-icon-alt btn-icon-hover" />
          </button>
        ...
        <div class="inbox-menu-group">
          ...
          <div class="inbox-menu-pagination-btn">
            <button class="btn btn-nofill btn-pagination">
              <img src={chevron_left_black_24dp} alt="Newer" class="btn-icon-sm btn-icon-alt" />
            </button>

            <button class="btn btn-pagination">
              <img src={chevron_right_black_24dp} alt="Older" class="btn-icon-sm btn-icon-alt btn-icon-hover" />
            </button>
          </div>

          <div class="inbox-btn-group" >
            <button class="btn-alt">
              <img src={keyboard_black_24dp} alt="Input tools on/off" class="btn-icon-sm btn-icon-alt" />
            </button>

            <button class="btn-sm btn-alt">
              <img src={arrow_drop_down_black_24dp} alt="Select input tool" class="btn-icon-sm btn-icon-alt" />
            </button>
          </div>
              ...
              <div class="footer-item">
                ...
                <a href="#" class="footer-link footer-text-sm">
                  ...
                  <div class="footer-group">
                    ...
                    <span>
                      <img style={{ height: "18px", width: "18px", margin: "0 8px", padding: "0" }} src="/app/assets/icons/open_in_new_black_24dp.svg" alt="Google drive storage" class="btn-icon-alt btn-icon-sm" />
                    </span>
                  </div>
